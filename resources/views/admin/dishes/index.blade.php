...
@section('content')
    ...
    <div class="d-flex flex-wrap row-cols-md-2 w-75 mx-auto justify-content-around align-items-center mb-4">
        <a id="new-dish-btn" href="{{ route('admin.dishes.create') }}" class="btn col-sm-1 col-md-2 m-2">Aggiungi un nuovo
            piatto</a>
        <form class="form-inline d-flex justify-content-between align-items-center my-auto" method="GET"
            action="{{ route('admin.dishes.index') }}">
            <input class="form-control col-md-7 col-sm-12 m-1" type="search" placeholder="Cerca un piatto..."
                name="name">
                        ...
                        <div class="card-body d-flex flex-column w-100">
                            ...
                            <div class="w-100" style="margin-bottom: auto">
                                ...
                                @if ($dish->image)
                                    @if (Str::startsWith($dish->image, 'http'))
                                        <div
                                            style="width: 100%; height: 150px; background-image: url({{ $dish->image }}); background-size: cover; background-position: center">

                                        </div>
                                    @else
                                        <div
                                            style="width: 100%; height: 150px; background-image: url({{ asset("storage/$dish->image") }}); background-size: cover; background-position: center">

                                        </div>
                                    @endif
                                @else
                                    <div
                                        style="width: 100%; height: 150px; background-image: url('https://2csolution.it/wp-content/themes/consultix/images/no-image-found-360x260.png'); background-size: cover; background-position: center">
                                ...
                                <p
                                    class="text-capitalize text-center badge badge-pill badge-deliveboo w-50 align-self-center">
                            ...
                            <div>
                                ...
                                <div class="d-flex justify-content-around align-items-end" style="height: auto">
                                    <a href="{{ route('admin.dishes.show', $dish->id) }}" class="btn show-button"><i
                                            class="fa-solid fa-eye"></i></a>
                                    <a href="{{ route('admin.dishes.edit', $dish->id) }}" class="btn edit-button"><i
                                    ...
                                    <form action="{{ route('admin.dishes.destroy', $dish->id) }}"
                                        ...
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn delete-button" value="Elimina"><i
