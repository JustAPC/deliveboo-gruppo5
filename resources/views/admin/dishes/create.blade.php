    ...
    <div class="container mt-5 pt-5">
        ...
        <form action="{{ route('admin.dishes.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
            ...
            <div class="form-group floating">
                <input type="text" id="name" name="name" required value="{{ old('name') }}" class="form-control floating">
            ...
            <div class="form-row">
                ...
                <div class="form-group floating col-md-8">
                    <input type="text" id="ingredients" name="ingredients" required value="{{ old('ingredients') }}" class="form-control floating">
                    <div class="invalid-feedback">
                ...
                <div class="form-group floating col-md-2">
                    <input type="number" id="price" name="price" required value="{{ old('price') }}" class="form-control floating">
                    <div class="invalid-feedback">
                        Inserisci il prezzo
                    </div>
            ...
            <div class="form-row">
                <div class="form-group floating col-md-8">
                    <input type="text" id="description" name="description" value="{{ old('description') }}" class="form-control floating">
            ...
            <div class="form-row d-flex align-items-center">
                <div class="form-group col-md-4">
                    ...
                    <button id="file_remove" class="btn btn-outline-deliveboo" disabled>Rimuovi</button>
